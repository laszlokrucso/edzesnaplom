...
export function hydrateMeta(data,draft,saved={}){
  const meta={autoRest:true,defaultRest:90,restByExercise:{},exerciseNotes:{},savedAt:null,dirtyWorkoutIds:[],remindAfter:5,lastExportAt:null,timer:{end:null,remaining:90},...clone(saved||{})};
